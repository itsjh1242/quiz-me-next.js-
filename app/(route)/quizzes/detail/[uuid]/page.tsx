...
import { GetQuizById, GetParticipantById, DisableQuizById } from "../../Quiz";
...
const QuizDetailPage = ({ params }: { params: any }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (id) {
        ...
        // Participants Data
        const participantData = await GetParticipantById(id as string);
