"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[358],{5002:function(e,t,n){n.d(t,{EK:function(){return O},IO:function(){return i8},JU:function(){return ik},PL:function(){return sd},QT:function(){return sh},Xo:function(){return st},ad:function(){return iR},ar:function(){return i6},hJ:function(){return iN},pl:function(){return sf},r7:function(){return sm}});var r,i,s,a,o=n(9279),l=n(2680),u=n(9053),h=n(3943),c=n(6552),d=n(4575);n(357);var f=n(6300).Buffer;let m="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function sh(e){e=iE(e,iS);let t=iE(e.firestore,ib);return(function(e,t,n={}){let r=new A;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,n,r,i){let s=new io({next:s=>{t.enqueueAndForget(()=>rV(e,a));let o=s.docs.has(n);!o&&s.fromCache?i.reject(new S(C.UNAVAILABLE,"Failed to get document because the client is offline.")):o&&s.fromCache&&r&&"server"===r.source?i.reject(new S(C.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):i.resolve(s)},error:e=>i.reject(e)}),a=new rU(new e3(n.path),s,{includeMetadataChanges:!0,ra:!0});return rM(e,a)})(await im(e),e.asyncQueue,t,n,r)),r.promise})(ix(t),e._key).then(n=>(function(e,t,n){let r=n.docs.get(t._key),i=new sc(e);return new so(e,i,t._key,r,new sa(n.hasPendingWrites,n.fromCache),t.converter)})(t,e,n))}class sc extends ss{constructor(e){super(),this.firestore=e}convertBytes(e){return new iM(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new iS(this.firestore,null,t)}}function sd(e){e=iE(e,iC);let t=iE(e.firestore,ib),n=ix(t),r=new sc(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
